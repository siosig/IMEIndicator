...
internal static partial class NativeMethods
{
    ...
    // EnumDisplayMonitors用デリゲートとAPI
    // Note: デリゲートコールバックを使用するため DllImport を維持（EnumWindowsと同パターン）
    ...
    // Note: MONITORINFOEX の ByValTStr が LibraryImport 非対応のため DllImport を維持
